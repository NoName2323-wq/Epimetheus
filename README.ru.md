...
![Тесты](https://img.shields.io/badge/Тесты-44%20Модульных%20Теста-brightgreen?style=for-the-badge)
...
| **Набор тестов** | 9 тестов (базовые) | **44 модульных теста** (40 активных, 4 локальных) | **Комплексный набор тестов** |
