...
![Тесты](https://img.shields.io/badge/Тесты-52%20Модульных%20Теста-brightgreen?style=for-the-badge)
...
| **Набор тестов** | 9 тестов (базовые) | **52 модульных теста** (48 активных, 4 локальных) | **Комплексный набор тестов** |
