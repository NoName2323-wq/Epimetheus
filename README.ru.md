...
![Тесты](https://img.shields.io/badge/Тесты-30%20Модульных%20Тестов-brightgreen?style=for-the-badge)
...
| **Набор тестов** | 9 тестов (базовые) | **30 модульных тестов** (26 активных, 4 локальных) | **Комплексный набор тестов** |
